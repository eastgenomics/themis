...
ASSAYS and REPORT_ASSAYS are similar but different variables. ASSAYS sets what is queried from DNAnexus, i.e. which 002 projects are searched for, and which runs are included in the report. REPORT_ASSAYS sets what is included in the final report, i.e. which assays are plotted and shown in the stats table.
